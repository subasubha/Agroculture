...
<meta  charset="utf-8">
<title>Agroculture.com/Farmers Delivery Details(COD)</title>
</head>

<body>
<h2> Welcome To Manage The Delivery Details Of Farmers Section (Cash On Delivery)</h2>
...
<td data-label="Delete" align="center"><a href="ftdelete.php?tid=<?php echo $row['tid']; ?> "><button class="btn2">Delete</button></a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
