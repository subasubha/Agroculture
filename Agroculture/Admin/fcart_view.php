...
<meta  charset="utf-8">
<title>Agroculture.com/Farmers Cart</title>
</head>

<body>
<h2> Welcome To Manage The Products Added To Cart By Farmers Section </h2>
...
<td data-label="Delete" align="center"><a href="fcdelete.php?oid=<?php echo $row['oid']; ?> "><button class="btn2">Delete</button></a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
