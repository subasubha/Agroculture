...
<meta  charset="utf-8">
<title>Agroculture.com/Farmers orders(OP)</title>
</head>

<body>
<h2> Welcome To Manage The Products Ordered By Farmers Section (Online Payment) </h2>
...
<td data-label="Delete" align="center"><a href="fopodelete.php?oid=<?php echo $row['oid']; ?> "><button class="btn2">Delete</button></a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
