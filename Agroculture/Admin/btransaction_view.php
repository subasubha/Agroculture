...
<meta  charset="utf-8">
<title>Agroculture.com/Buyers Delivery details(COD)</title>
</head>

<body>
<h2> Welcome To Manage The Delivery Details Of Buyers Section (Cash On Delivery)</h2>
...
<td data-label="DATE" align="center"><?php echo $row["dod"]; ?> </td>
<td data-label="Cost" align="center"><?php echo $row["cost"]; ?> </td>
<td data-label="Buyer Name" align="center"><?php echo $row["name"]; ?> </td>
...
<td data-label="Delete" align="center"><a href="btdelete.php?tid=<?php echo $row['tid']; ?> "><button class="btn2">Delete</button></a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
