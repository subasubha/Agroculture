...
<meta  charset="utf-8">
<title>Agroculture.com/Buyers Delivery Details(OP)</title>
</head>

<body>
<h2> Welcome To Manage The Delivery Details Of Buyers Section (Online Payment)</h2>
...
<td data-label="Delete" align="center"><a href="boptdelete.php?tid=<?php echo $row['tid']; ?> "><button class="btn2">Delete</button></a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
