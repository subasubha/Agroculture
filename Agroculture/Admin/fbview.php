...
<meta  charset="utf-8">
<title>Agroculture.com/FEEDBACKS</title>
</head>

<body>
<h2> Welcome To FEEDBACK Section</h2>
...
<td data-label="Messages" align="center"><?php echo $row["message"]; ?> </td>
<td data-label="Delete" align="center"><a href="fbdelete.php?mid=<?php echo $row['mid']; ?> "><button class="btn2">Delete</button></a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
