...
<html>
    ...
    <body>
        ...
        <h2>
  <a href="bmycart.php?pid=<?= $pid;?>" class="but1">Go Back</a>
  <a href="bcarddetails.php?pid=<?= $pid; ?>" class="but2">Pay Online</a>
  <a href="bbuyNow.php?pid=<?= $pid; ?>" class="but2">Cash On Delivery</a>
</h2></div>
        </section>
</div>
    </body>
