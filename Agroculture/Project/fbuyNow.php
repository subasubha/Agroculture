<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        $sql = "INSERT INTO ftransaction (fid, dod, cost, name, city, mobile, email, pincode, addr)
        ...
        $resu =mysqli_query($conn, "SELECT  MAX(tid) as max , MIN(tid) as min FROM ftransaction");
        ...
        $sqli = "INSERT INTO forders (fid, pid, dod, tid)
    ...
    <body>
        <div class="container">
            <div class="card">
                ...
                <form method="post" action="fbuyNow.php?pid=<?= $pid; ?>">
                <?php
