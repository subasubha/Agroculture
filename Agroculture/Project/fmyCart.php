<?php
    ...
    if(isset($_GET['flag']))
    {
        ...
        $sql = "INSERT INTO fmycart (fid,pid,datee)
               VALUES ('$fid', '$pid','$date')";
...
font-size:36px;
            ...
            body{
                ...
                font-family: Arial;
                width:100%;
                background-image:linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8)), url('nkk.jpg');
    ...
    <body>
        <div class="wrap">
            <div class="top_nav">
                ...
                <ul>
                    ...
                    <li><a class="active" href="fmyCart.php">My Cart</a></li>
                </ul>
            </div>
            <section class="backg">
				<div class="h1">
        ...
        <div style="text-align:center; color:rgb(255, 233, 192);"><h2>DELIVERY CHARGE : 40 /-</h2></div>
        <div class="form">
<table>
<thead>
<tr>
...
<td><a href="freview.php?pid=<?php echo $row['pid'] ;?>"><img src="<?php echo $picDestination; ?>" alt="" width="200" height="150"></a></td>
<td><a href="fcfdelete.php?oid=<?php echo $row['oid']; ?>" class="but1"><span class="glyphicon glyphicon-shopping-cart">Remove</a></td>
</tr>
<?php endwhile;	?>
<tr>
...
<tr>
<td colspan="6" align="right"><a href="fpayment.php?pid=<?= $pid; ?>" class="but2">Buy Now</a></td>
                        </tr>
</table>
</div>
</section>
