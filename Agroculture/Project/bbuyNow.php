<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        $sql = "INSERT INTO btransaction (bid, dod, cost, name, city, mobile, email, pincode, addr)
        ...
        $resu =mysqli_query($conn, "SELECT  MAX(tid) as max , MIN(tid) as min FROM btransaction");
        ...
        $sqli = "INSERT INTO borders (bid, pid, dod, tid)
...
<html>
    <head>
        <title>Agroculture.com/Buyer : <?php echo $_SESSION['Uname'] ?></title>
        <style>
            body{
                font-family: sans-serif;  
                background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(future.jpg);
    ...
    <body>
        <div class="container">
            <div class="card">
                ...
                <form method="post" action="bbuyNow.php?pid=<?= $pid; ?>">
                <?php
            ...
            <div class="buttonrow">
                <a href="bpayment.php?pid=<?= $pid; ?>" class="but1"><span class="glyphicon glyphicon-shopping-cart">Back</a>
            </div>
        </div>
    </body>
</html>